  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        ...
        // Filter out courses without titles for the dropdown
    ...
    >
      ...
      >
        ...
        >
          {fileName ? (
            <>
              <p style={{ color: "#00C853", fontSize: "16px", fontWeight: 500, fontFamily: "Poppins, sans-serif" }}>
                {fileName}
              </p>
            ...
            <>
              ...
              <p style={{ fontFamily: "Poppins, sans-serif", fontWeight: 500, fontSize: "16px", color: "#C9C9C9", marginTop: "10px" }}>
                Upload document
              </p>
            </>
          )}
        ...
        {/* INPUT: CATEGORY (COURSE DROPDOWN) */}
        <select
          value={category}
